...
<div class="jumbotron mb-2 pt-4 card">
        <h1  class="text-dark text-center hero-text">RANDEVU OLUŞTURUN</h1>
        
    </div>
    <div class="container">
        <form action="https://formspree.io/f/mgegeozz" method="POST" class="row g-3 needs-validation" novalidate>
  <div class="col-md-4">
