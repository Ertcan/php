...
<div class="jumbotron mb-2 pt-4 card">
        <h1  class="text-dark text-center hero-text">HAKKIMIZDA</h1>
        <hr>
    </div>
    <img src="img/hakkinda.png" class="img-fluid" style="width: 100%; height: auto;">
    <div class="row">
        <div class="col">
            <div class="container">
                <div class="card">
                <div class="card-body">
                    <p class="card-text">
                        Sağlıklı beslenmek istiyorum fakat hazırlamaya zamanım yok diyorsanız işte tam olarak bunun için varız.
                        Kişilere özel diyetisyen tarafından planlanmış sağlıklı, lezzetli ve yenilikçi yemekler üretiyoruz.
                        Bu yemekleri üretmekle kalmayıp adresinize teslim ediyoruz.
                        Bugün ne yiyeyim düşüncesinden kurtulup sağlıklı ve lezzetli yemekler yiyerek istediğiniz kiloya ulaşmanız için biz buradayız.
